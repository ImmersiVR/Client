...
import AddCleaner from "./components/screens/AddCleaner";
...
const Routing = () => {
  ...
  return (
    <Routes>
      ...
      <Route exact path="/addcleaner" element={<AddCleaner />}></Route>
      <Route exact path="/getRewards" element={<Rewards />}></Route>
      <Route
        exact
