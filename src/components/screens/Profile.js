      ...
      {state ? (
        <div style={{ maxWidth: "550px", margin: "0px auto" }}>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <h6>{mypics.length} Hotspots Cleaned</h6>
          ...
          <div className="gallery row">
            {mypics.map((item) => {
              return (
                <div className="col s4" style={{ height: "180px" }}>
                  <img
                    key={item._id}
                    className="item"
                    src={item.photo}
                    alt={item.title}
                    style={{ padding: "5px", height: "130px", width: "190px" }}
                  />
                  <div style={{ fontSize: "13px", marginLeft: "30px" }}>
                    {item.title}
                  </div>
